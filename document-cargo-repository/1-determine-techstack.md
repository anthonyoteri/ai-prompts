...
Add all your findings to ./{output_folder}/1-techstack.md
...
Once completed read [./2-categorize-files.md](./2-categorize-files.md) and continue on accordingly with {output_folder} as the `output_folder`